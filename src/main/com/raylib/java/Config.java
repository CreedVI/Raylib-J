...
public class Config{
    ...
    public final static boolean FBO_READ_TEXTURE_AS_RGBA = false;
    ...
    public final static int RL_DEFAULT_BATCH_DRAWCALLS = 256;      // Default number of batch draw calls (by state changes: mode, texture)
