...
public class Audio {
    ...
    public static Music LoadMusicStream(String fileName) {return null;}                                    // Load music stream from file
    static Music LoadMusicStreamFromMemory(String fileType, String data, int dataSize) {return null;} // Load music stream from data
    public static void UnloadMusicStream(Music music) {}                                           // Unload music stream
    public static void PlayMusicStream(Music music) {}                                            // Start music playing
    static boolean IsMusicPlaying(Music music) {return false;}                                            // Check if music is playing
    public static void UpdateMusicStream(Music music) {}                                         // Updates buffers for music streaming
    public static void StopMusicStream(Music music) {}                                            // Stop music playing
    public static void PauseMusicStream(Music music) {}                                          // Pause music playing
    public static void ResumeMusicStream(Music music) {}                                           // Resume playing paused music
    static void SetMusicVolume(Music music, float volume) {}                                // Set volume for music (1.0 is max level)
    public static void SetMusicPitch(Music music, float pitch) {}                              // Set pitch for a music (1.0 is base level)
    public static float GetMusicTimeLength(Music music) {return 0.0f;}                                         // Get music time length (in seconds)
    public static float GetMusicTimePlayed(Music music) {return 0.0f;}                                        // Get current music time played (in seconds)
