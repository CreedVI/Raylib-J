...
public class DrawCall{
    ...
    int vaoId;       // Vertex array id to be used on the draw . Using RLGL.currentBatch.vertexBuffer.vaoId
    int shaderId;    // Shader id to be used on the draw . Using RLGL.currentShader.id
